...
function Payment() {
  ...
  const spl_token = new PublicKey('EPjFWdd5AufqSSqeM2qN1xzybapC8G4wEGGkZwyTDt1v');
  ...
  const solana_pay_url = encodeURL({ recipient, splToken: spl_token, amount, reference, label, message });
  ...
  return (
    ...
    <QRCodeModal qrCode={qrCode} reference={reference} modalOpen={modalOpen} handleModalClose={handleModalClose}/>
    </div>
  );
}
